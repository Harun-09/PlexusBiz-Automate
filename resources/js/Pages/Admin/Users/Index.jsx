...
const statusTone = (value) => {
    ...
    if (['active', 'approved'].includes(n)) return 'border-emerald-400/30 bg-emerald-500/10 text-emerald-400';
    if (['suspended', 'rejected', 'inactive'].includes(n)) return 'border-rose-400/30 bg-rose-500/10 text-rose-400';
    ...
    return (
        <AdminLayout
            header={{
                ...
                subtitle: 'Create, edit, and manage platform users and their roles.'
            }}
        >

    ...
    return (
        <form onSubmit={submit} className="space-y-6">
            ...
            <div className="flex items-center gap-3 border-t border-gray-100 pt-6">
                ...
                <a href="/admin/products" className="inline-flex items-center rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm font-semibold text-gray-600 shadow-sm transition hover:bg-gray-50">
                    Cancel
                </a>
            </div>
        </form>

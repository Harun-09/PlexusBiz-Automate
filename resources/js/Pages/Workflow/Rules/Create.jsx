...
export default function Create({ auth, flash, errors, triggers = [], actions = [], statuses = [], operators = [] }) {
    const { data, setData, post, processing, reset } = useForm({
        name: 'Order Confirmation Rule',
        trigger_event: triggers[0] || 'order.placed',
    ...
    const submit = (event) => {
        ...
        post(route('workflow.rules.store'), {
            preserveScroll: true,
            onSuccess: () => reset(),
        });
    };
                            ...
                            <form onSubmit={submit} className="mt-6 space-y-5">
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    <div className="mt-4 grid gap-4 sm:grid-cols-3">
                                        <Field label="Payload Field" error={errors.condition_field} hint="Example: order.grand_total">

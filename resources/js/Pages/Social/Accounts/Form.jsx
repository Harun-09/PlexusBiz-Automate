                ...
                <PageHeader
                    ...
                    actions={
                        <Link
                            ...
                            className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-bold text-slate-700 transition hover:border-sky-200 hover:text-sky-800"
                        >
                            Back to accounts
                        </Link>
                    }

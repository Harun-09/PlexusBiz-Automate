...
const moduleConfig = {
    ...
    actions: [
        { label: 'Create Template', href: route('marketing.templates.create'), variant: 'primary' },
        { label: 'Back to Email Campaigns', href: route('marketing.campaigns.index'), variant: 'secondary' },
        {
